...
func (s *Service) SaveProject(ctx *models.Context, project *models.Project) error {
	...
	project.Status = constants.PROJECTOWNERSTATUSACTIVE
	t := time.Now()
	created := models.CreatedV2{}
	created.On = &t
	created.By = constants.SYSTEM
	log.Println("b4 project.created")
...
//FilterProject :""
func (s *Service) FilterProject(ctx *models.Context, projectfilter *models.ProjectFilter, pagination *models.Pagination) (project []models.RefProject, err error) {
