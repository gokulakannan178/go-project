...
type OffboardingPolicy struct {
	...
	OffboardCheckListMasterId []string           `json:"offboardchecklistmasterId,omitempty" bson:"-"`
	Created                   *Created           `json:"createdOn" bson:"createdOn,omitempty"`
	Status                    string             `json:"status,omitempty" bson:"status,omitempty"`
}

type RefOffboardingPolicy struct {
	OffboardingPolicy `bson:",inline"`
	Ref               struct {
		OrganisationID         Organisation           `json:"organisationId,omitempty" bson:"organisationId,omitempty"`
		OffboardingchecklistId []OffboardingCheckList `json:"offboardingchecklistId,omitempty" bson:"offboardingchecklistId,omitempty"`
	} `json:"ref,omitempty" bson:"ref,omitempty"`
}

type FilterOffboardingPolicy struct {
	Status         []string `json:"status,omitempty" bson:"status,omitempty"`
	OrganisationID []string `json:"organisationId,omitempty" bson:"organisationId,omitempty"`
	Regex          struct {
		Name string `json:"name,omitempty" bson:"name,omitempty"`
