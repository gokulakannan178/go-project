...
type Attendance struct {
	...
	WorkingHours          float64    `json:"workingHours," bson:"workingHours,omitempty"`
	WorkingHoursMins      float64    `json:"workingHoursMins," bson:"workingHoursMins,omitempty"`
	OverTime              float64    `json:"overtime," bson:"overtime,omitempty"`
	OverTimeMins          float64    `json:"overTimeMins," bson:"overTimeMins,omitempty"`
	...
	WorkscheduleHours     float64    `json:"workscheduleHours" bson:"workscheduleHours,omitempty"`
	Notes                 string     `json:"notes,omitempty" bson:"notes,omitempty"`
	Created               *Created   `json:"createdOn" bson:"createdOn,omitempty"`
	ClockInLocation       *Location  `json:"clockInLocation" bson:"clockInLocation,omitempty"`
	ClockOutLocation      *Location  `json:"clockOutLocation" bson:"clockOutLocation,omitempty"`
}
...
type TodayAbsent struct {
	ApprovedLeave       []RefEmployeeTimeOff `json:"approvedLeave" bson:"approvedLeave,omitempty"`
	PendingLeaveRequest []RefEmployeeTimeOff `json:"pendingLeaveRequest" bson:"pendingLeaveRequest,omitempty"`
}
...
type AllEmployeeAttendanceApprove struct {
	Employees []EmployeeAttendanceApprove `json:"employees,omitempty" bson:"employees,omitempty"`
}
