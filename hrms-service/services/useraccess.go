...
func (s *Service) GetSingleUserAclWithUserType(ctx *models.Context, UniqueID string) (*models.RefUserAcl, error) {
	useracl, err := s.Daos.GetSingleUserAclWithUserType(ctx, UniqueID)
	if err != nil {
		return nil, err
	}
	return useracl, nil
