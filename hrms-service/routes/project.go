...
//Project : ""
func (route *Route) Project(r *mux.Router) {
	...
	r.Handle("/project/addteammember", Adapt(http.HandlerFunc(route.Handler.SaveProjectTeamMember))).Methods("POST")
	r.Handle("/project/status/removeteammember", Adapt(http.HandlerFunc(route.Handler.DisableProjectTeamMember))).Methods("PUT")
