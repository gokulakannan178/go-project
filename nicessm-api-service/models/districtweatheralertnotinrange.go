...
type DistrictWeatherAlertNotInRange struct {
...
type DistrictWeatherAlertNotInRangeFilter struct {
	Status       []string `json:"status,omitempty" bson:"status,omitempty"`
	ActiveStatus []bool   `json:"activeStatus" bson:"activeStatus,omitempty"`
...
type RefDistrictWeatherAlertNotInRange struct {
	DistrictWeatherAlertNotInRange `bson:",inline"`
	Ref                            struct {
