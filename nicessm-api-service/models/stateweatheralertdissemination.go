...
type StateWeatherAlertDissimination struct {
...
type StateWeatherAlertDissiminationFilter struct {
	Status                 []string             `json:"status,omitempty" bson:"status,omitempty"`
...
type RefStateWeatherAlertDissimination struct {
	StateWeatherAlertDissimination `bson:",inline"`
	Ref                            struct {
