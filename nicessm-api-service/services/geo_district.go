...
func (s *Service) SaveDistrict(ctx *models.Context, district *models.District) error {
	...
	district.UniqueID = s.Daos.GetUniqueID(ctx, constants.COLLECTIONDISTRICT)
...
func (s *Service) FilterDistrict(ctx *models.Context, districtfilter *models.DistrictFilter, pagination *models.Pagination) (district []models.RefDistrict, err error) {
	...
	if districtfilter != nil {
		...
		dataaccess, err := s.Daos.DataAccess(ctx, &districtfilter.DataAccess)
		if err != nil {
			return nil, err
		}
		if dataaccess != nil {
			if len(dataaccess.AccessDistricts) > 0 {
				for _, v := range dataaccess.AccessDistricts {
					districtfilter.ID = append(districtfilter.ID, v.ID)
				}
			}
...
func (s *Service) GetDistrictWeatherDataWithSeverityType(ctx *models.Context, filter *models.StateWeatherAlertMasterFilterv2, pagination *models.Pagination) (state []models.GetDistrictLeveWeatherDataAlert, err error) {
	return s.Daos.GetDistrictWeatherDataWithSeverityType(ctx, filter, pagination)
