...
func (s *Service) SaveCategory(ctx *models.Context, category *models.Category) error {
	...
	log.Println("b4 Category.created")
...
//FilterCategory :""
func (s *Service) FilterCategory(ctx *models.Context, filter *models.CategoryFilter, pagination *models.Pagination) (Category []models.RefCategory, err error) {
