...
func (s *Service) SaveSubCategory(ctx *models.Context, subcategory *models.SubCategory) error {
	...
	subcategory.ActiveStatus = true
	t := time.Now()
	created := models.Created{}
	created.On = &t
	created.By = constants.SYSTEM
	log.Println("b4 SubCategory.created")
...
//FilterSubCategory :""
func (s *Service) FilterSubCategory(ctx *models.Context, filter *models.SubCategoryFilter, pagination *models.Pagination) (SubCategory []models.RefSubCategory, err error) {
