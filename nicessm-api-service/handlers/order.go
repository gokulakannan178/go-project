...
func (h *Handler) UpdateOrder(w http.ResponseWriter, r *http.Request) {
	...
	err = h.Service.UpdateOrder(ctx, order)
	if err != nil {
		response.With500mV2(w, "failed - "+err.Error(), platform)
		return
	}
...
//EnableOrder : ""
func (h *Handler) EnableOrder(w http.ResponseWriter, r *http.Request) {
	...
	err := h.Service.EnableOrder(ctx, UniqueID)
	if err != nil {
		response.With500mV2(w, "failed - "+err.Error(), platform)
		return
	}
...
//DisableOrder : ""
func (h *Handler) DisableOrder(w http.ResponseWriter, r *http.Request) {
	...
	err := h.Service.DisableOrder(ctx, code)
	if err != nil {
		response.With500mV2(w, "failed - "+err.Error(), platform)
		return
	}
...
func (h *Handler) DeleteOrder(w http.ResponseWriter, r *http.Request) {
	...
	err := h.Service.DeleteOrder(ctx, UniqueID)
	if err != nil {
		response.With500mV2(w, "failed - "+err.Error(), platform)
		return
	}
