...
func (d *Daos) SaveStateWeatherDataWithUpsert(ctx *models.Context, stateweatherdata *models.StateWeatherData) error {
...
func (d *Daos) GetSingleStateWeatherDataWithCurrentDate(ctx *models.Context, UniqueID string) (*models.RefStateWeatherData, error) {
	id, err := primitive.ObjectIDFromHex(UniqueID)
	if err != nil {
		return nil, err
	}
