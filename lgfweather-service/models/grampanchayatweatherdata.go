...
//GramPanchayatWeatherDataWeatherData : ""
type GramPanchayatWeatherDataV2 struct {
	ID                       primitive.ObjectID `json:"id" form:"id," bson:"_id,omitempty"`
	Name                     string             `json:"name" bson:"name"`
	ActiveStatus             bool               `json:"activeStatus" bson:"activeStatus,omitempty"`
	GramPanchayatWeatherData primitive.ObjectID `json:"GramPanchayatWeatherData" bson:"GramPanchayatWeatherData,omitempty"`
...
type GramPanchayatWeatherData struct {
	ID            primitive.ObjectID `json:"id" form:"id," bson:"_id,omitempty"`
	Name          string             `json:"name" bson:"name"`
	UniqueID      string             `json:"uniqueId" bson:"uniqueId,omitempty"`
	ActiveStatus  bool               `json:"activeStatus" bson:"activeStatus,omitempty"`
	GramPanchayat primitive.ObjectID `json:"GramPanchayatWeatherData" bson:"GramPanchayatWeatherData,omitempty"`
	Status        string             `json:"status,omitempty"  bson:"status,omitempty"`
	Created       *Created           `json:"created,omitempty"  bson:"created,omitempty"`
	CreatedDate   *time.Time         `json:"createdDate,omitempty"  bson:"createdDate,omitempty"`
	Date          time.Time          `json:"date,omitempty"  bson:"date,omitempty"`
...
type GramPanchayatWeatherDataFilter struct {
	Status        []string             `json:"status,omitempty" bson:"status,omitempty"`
	ActiveStatus  []bool               `json:"activeStatus" bson:"activeStatus,omitempty"`
	GramPanchayat []primitive.ObjectID `json:"GramPanchayatWeatherData" bson:"GramPanchayatWeatherData,omitempty"`
...
type RefGramPanchayatWeatherData struct {
	GramPanchayatWeatherData `bson:",inline"`
	Ref                      struct {
		GramPanchayatWeatherData GramPanchayatWeatherData `json:"GramPanchayatWeatherData" bson:"GramPanchayatWeatherData,omitempty"`
