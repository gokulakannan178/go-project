...
//VillageWeatherData : ""
type VillageWeatherDataV2 struct {
...
type VillageWeatherData struct {
	ID           primitive.ObjectID `json:"id" form:"id," bson:"_id,omitempty"`
	Name         string             `json:"name" bson:"name"`
...
type VillageWeatherDataFilter struct {
	Status       []string             `json:"status,omitempty" bson:"status,omitempty"`
	ActiveStatus []bool               `json:"activeStatus" bson:"activeStatus,omitempty"`
	Village      []primitive.ObjectID `json:"Village" bson:"Village,omitempty"`
...
type RefVillageWeatherData struct {
	VillageWeatherData `bson:",inline"`
	Ref                struct {
