...
func (route *Route) CircleRoutes(r *mux.Router) {
	r.Handle("/circle", Adapt(http.HandlerFunc(route.Handler.SaveCircle))).Methods("POST")
	r.Handle("/circle", Adapt(http.HandlerFunc(route.Handler.GetSingleCircle))).Methods("GET")
	r.Handle("/circle", Adapt(http.HandlerFunc(route.Handler.UpdateCircle))).Methods("PUT")
	r.Handle("/circle/status/enable", Adapt(http.HandlerFunc(route.Handler.EnableCircle))).Methods("PUT")
	r.Handle("/circle/status/disable", Adapt(http.HandlerFunc(route.Handler.DisableCircle))).Methods("PUT")
	r.Handle("/circle/status/delete", Adapt(http.HandlerFunc(route.Handler.DeleteCircle))).Methods("DELETE")
	r.Handle("/circle/filter", Adapt(http.HandlerFunc(route.Handler.FilterCircle))).Methods("POST")
}

func (route *Route) SectorRoutes(r *mux.Router) {
	r.Handle("/sector", Adapt(http.HandlerFunc(route.Handler.SaveSector))).Methods("POST")
	r.Handle("/sector", Adapt(http.HandlerFunc(route.Handler.GetSingleSector))).Methods("GET")
	r.Handle("/sector", Adapt(http.HandlerFunc(route.Handler.UpdateSector))).Methods("PUT")
	r.Handle("/sector/status/enable", Adapt(http.HandlerFunc(route.Handler.EnableSector))).Methods("PUT")
	r.Handle("/sector/status/disable", Adapt(http.HandlerFunc(route.Handler.DisableSector))).Methods("PUT")
	r.Handle("/sector/status/delete", Adapt(http.HandlerFunc(route.Handler.DeleteSector))).Methods("DELETE")
	r.Handle("/sector/filter", Adapt(http.HandlerFunc(route.Handler.FilterSector))).Methods("POST")
}
