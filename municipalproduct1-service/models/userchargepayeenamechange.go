...
type UserchargePayeeNameChange struct {
...
type UserchargePayeeNameChangeFilter struct {
	Status     []string   `json:"status" bson:"status,omitempty"`
...
type RefUserchargePayeeNameChange struct {
	UserchargePayeeNameChange `bson:",inline"`
	Ref                       struct {
	} `json:"ref" bson:"ref,omitempty"`
}

type ApproveUserchargePayeeNameChange struct {
