...
type ShoprentPaymentModeChange struct {
	...
	Previous      ShopRentPaymentDetails `json:"previous" bson:"previous,omitempty"`
	New           ShopRentPaymentDetails `json:"new" bson:"new,omitempty"`
...
type ShoprentPaymentModeChangeFilter struct {
...
type RefShoprentPaymentModeChange struct {
	ShoprentPaymentModeChange `bson:",inline"`
	Ref                       struct {
...
type AcceptShoprentPaymentModeChange struct {
	UniqueID string     `json:"uniqueId,omitempty" bson:"uniqueId,omitempty"`
...
type RejectShoprentPaymentModeChange struct {
	UniqueID string     `json:"uniqueId,omitempty" bson:"uniqueId,omitempty"`
	On       *time.Time `json:"on" form:"on" bson:"on,omitempty"`
	Remark   string     `json:"remark,omitempty" bson:"remark,omitempty"`
	UserName string     `json:"userName,omitempty" bson:"userName,omitempty"`
