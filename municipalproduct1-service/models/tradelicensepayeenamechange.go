...
type TradelicensePayeeNameChange struct {
...
type TradelicensePayeeNameChangeFilter struct {
	Status     []string   `json:"status" bson:"status,omitempty"`
...
type RefTradelicensePayeeNameChange struct {
	TradelicensePayeeNameChange `bson:",inline"`
	Ref                         struct {
	} `json:"ref" bson:"ref,omitempty"`
}

type ApproveTradelicensePayeeNameChange struct {
