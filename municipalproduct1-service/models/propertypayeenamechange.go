...
type PropertyPayeeNameChange struct {
...
type PropertyPayeeNameChangeFilter struct {
	Status     []string   `json:"status" bson:"status,omitempty"`
...
type RefPropertyPayeeNameChange struct {
	PropertyPayeeNameChange `bson:",inline"`
	Ref                     struct {
	} `json:"ref" bson:"ref,omitempty"`
}

type ApprovePropertyPayeeNameChange struct {
