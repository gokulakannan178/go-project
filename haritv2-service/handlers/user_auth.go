...
//OTPLoginGenerateOTP : "Login user"
func (h *Handler) FPOLoginGenerateOTP(w http.ResponseWriter, r *http.Request) {
	platform := r.URL.Query().Get("platform")
	var ctx *models.Context
	ctx = app.GetApp(r.Context(), h.Service.Daos)
	defer ctx.Client.Disconnect(r.Context())
	...
	err = h.Service.FPOLoginGenerateOTP(ctx, user)
...
//OTPLoginValidateOTP : "Login user using OTP"
func (h *Handler) FPOLoginValidateOTP(w http.ResponseWriter, r *http.Request) {
	platform := r.URL.Query().Get("platform")
	var ctx *models.Context
	ctx = app.GetApp(r.Context(), h.Service.Daos)
	defer ctx.Client.Disconnect(r.Context())
	...
	// if user.Mobile == "0000001234" {
	// 	return
	// }
	userdata, stat, err := h.Service.FPOLoginValidateOTP(ctx, user)
...
func (h *Handler) FPORegistrationLoginGenerateOTP(w http.ResponseWriter, r *http.Request) {
	platform := r.URL.Query().Get("platform")
	var ctx *models.Context
	ctx = app.GetApp(r.Context(), h.Service.Daos)
	defer ctx.Client.Disconnect(r.Context())
	...
	err = h.Service.FPORegistrationLoginGenerateOTP(ctx, user)
...
func (h *Handler) FPORegistrationLoginValidateOTP(w http.ResponseWriter, r *http.Request) {
	platform := r.URL.Query().Get("platform")
	var ctx *models.Context
	ctx = app.GetApp(r.Context(), h.Service.Daos)
	defer ctx.Client.Disconnect(r.Context())
	...
	_, stat, err := h.Service.FPORegistrationLoginValidateOTP(ctx, user)
...
func (h *Handler) FPORegistrationMobileUniqueness(w http.ResponseWriter, r *http.Request) {
	platform := r.URL.Query().Get("platform")
	var mobile string
	var ctx *models.Context
	ctx = app.GetApp(r.Context(), h.Service.Daos)
	...
	err = h.Service.FPORegistrationMobileUniqueness(ctx, mobile)
	if err != nil {
