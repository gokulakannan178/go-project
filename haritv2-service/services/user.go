...
// // GetSingleUserAndRolewithUniqueID : ""
// func (s Service) GetSingleUserAndRolewithUniqueID(ctx *models.Context, userName string) (string, *models.RefUser, error) {
// 	user, err := s.Daos.GetSingleUser(ctx, userName)
// 	if err != nil {
// 		fmt.Println("err in getinguser", err.Error())
// 	}
// 	name := ""
...
// 		role, err := s.Daos.GetSingleRole(ctx, user.Role)
// 		if err != nil {
// 			fmt.Println("err in geting role name", err.Error())
// 		}
// 		if err == nil {
// 			name = role.Name
// 		}
