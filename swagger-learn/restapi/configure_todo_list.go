...
import (
	...
	"swagger-learn/models"
	"swagger-learn/restapi/operations"
	"swagger-learn/restapi/operations/todos"
)

//go:generate swagger generate server --target ..\..\swagger-learn --name TodoList --spec ..\swagger.yml --principal interface{}
